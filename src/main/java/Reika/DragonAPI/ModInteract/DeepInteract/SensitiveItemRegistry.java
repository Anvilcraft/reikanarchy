...
/**
 * Register progression/balance-sensitive items here to blacklist normal recipe systems
 * from adding new recipes for them.
 */
public final class SensitiveItemRegistry {
    ...
    private final OneWayMap<DragonAPIMod, OneWaySet<KeyedItemStack>> byMod
        = new OneWayMap();
    ...
    private void
    onRegisterItem(DragonAPIMod mod, KeyedItemStack item, boolean allowRecipes) {
