...
/**
 * Register progression/balance-sensitive fluids here to blacklist other mods from adding
 * shortcuts to obtain them.
 */
public final class SensitiveFluidRegistry {
    ...
    private SensitiveFluidRegistry() {
        ...
        try {
            fluidCowClass
                = Class.forName("com.robrit.moofluids.common.entity.EntityFluidCow");
            ...
            switch (this) {
                ...
                case RFTOOLS:
                    FMLInterModComms.sendMessage(
                        "rftools", "dimlet_blacklist", "Liquid." + fluid.getName()
                    );
                    break;
            }
        }
