        ...
        if (this.hasMod()) {
            try {
                ...
                for (BasicHexColors hex : BasicHexColors.values()) {
                    ...
                    hex.block = GameRegistry.findBlock(
                        this.getMod().modLabel, "blockHexoriumMonolith" + key
                    );
                    hex.netherBlock = GameRegistry.findBlock(
                        this.getMod().modLabel, "blockHexoriumNetherMonolith" + key
                    );
                    BasicHexColors.lookup.put(hex.crystal, hex);
                    BasicHexColors.lookup.put(Item.getItemFromBlock(hex.block), hex);
                    BasicHexColors.lookup.put(
                        Item.getItemFromBlock(hex.netherBlock), hex
                    );
                }
